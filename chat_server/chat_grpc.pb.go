...
func (x *servicesChatServiceClient) Send(m *ClientMsg) error {
	return x.ClientStream.SendMsg(m)
}

func (x *servicesChatServiceClient) Recv() (*ServerMsg, error) {
	m := new(ServerMsg)
...
func (x *servicesChatServiceServer) Send(m *ServerMsg) error {
	return x.ServerStream.SendMsg(m)
}

func (x *servicesChatServiceServer) Recv() (*ClientMsg, error) {
	m := new(ClientMsg)
